...
export function InformationBadges() {
  return (
    <motion.div className="bg-neutral-100 z-10 py-section-y-mobile md:py-section-y px-section-x-mobile md:px-section-x flex flex-col items-center">
      <ScatterText className="text-3xl md:text-4xl font-heading uppercase">
