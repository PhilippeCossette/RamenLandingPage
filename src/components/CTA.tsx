...
export default function CTA() {
  return (
    <section className="mx-auto min-h-screen grid grid-cols-1 lg:grid-cols-2 grid-rows-[auto_1fr] lg:grid-rows-[1fr_1fr] items-center bg-gradient-to-tr from-neutral-200 to-neutral-300 py-section-y-mobile md:py-section-y px-section-x-mobile md:px-section-x gap-6 lg:gap-x-12">
      <h2 className="text-6xl uppercase font-heading mb-3 lg:text-center lg:col-start-1 lg:row-start-1 lg:place-self-end">
